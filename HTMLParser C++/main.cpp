...
int main(int argc, const char * argv[]) {
    ...
    <main class="main ano" id="jasmine_content" style="width: fit-content" #main>

            <p *ngFor="let i of users">PPP {{i}}</p>
        ...
        <button (click)="nullUsers" appTooltip [tool]="title">Zero out Users</button>
        <div class="user-grid">
            ...
            <ng-if condition="title == 'ng-app'">
                <div>Dashboard</div>
                <button (click)="login">Login</button>

                <ng-elseif condition="title === 'nnamdi'">
                    User
                </ng-elseif>
            ...
            <ng-if condition="true">
                <div>Hello if</div>
            </ng-if>

            <ng-switch condition="title">
                <ng-case value="'nnamdi'">
                    <div>Loading...</div>
                </ng-case>

                <ng-case value="'ng-app'">
                    <div>Done</div>
                </ng-case>
